<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\newstype\show.html";i:1526371536;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeU">
                                    ...
                                    <td><button onclick="del(<?php echo $v['t_id']; ?>,<?php echo $p['page']; ?>)" >删除</button><a href="<?php echo url('newstype/update'); ?>?id=<?php echo $v['t_id']; ?>">修改</a></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                                </table>
...
<script>
    ...
    xhr.open('get',"<?php echo url('newstype/dele'); ?>?id="+id+"&page="+page);
    xhr.send();
    xhr.onreadystatechange=function(){
      ...
      var respon=xhr.responseText
        ...
        for(var i=0;i<content.length;i++)
                        {
  str+="<tr class='gradeU'><td>"+content[i]['t_id']+"</td>";
str+="<td>"+content[i]['t_type']+"</td>";
str+="<td><button onclick='del("+content[i]['t_id']+","+content[i]['page']+")' >删除</button><a href='/index/newstype/dele?id="+content[i]['t_id']+"'>修改</a></td></tr>";
document.getElementsByTagName('tbody')[0].innerHTML=str;
    ...
    function page(page){
    var xhr=new XMLHttpRequest();
    xhr.open('get',"<?php echo url('newstype/show'); ?>?page="+page);
    xhr.send();
    xhr.onreadystatechange=function(){
      if (xhr.readyState==4&&xhr.status==200) {
