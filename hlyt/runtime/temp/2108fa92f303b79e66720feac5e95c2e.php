<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\infor\add.html";i:1526374352;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="/index/infor/add" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>新闻标题</label>
                                        <input class="form-control" type    ="text" name="infor_title">
                                    </div>
                                     <div class="form-group">
                                        <label>新闻图片</label>
                                        <input  type    ="file" name="infor_img">
                                    </div>
                                     <div class="form-group">
                                        <label>新闻login</label>
                                        <textarea  class="form-control" rows="3" name="infor_content"></textarea>
                                    </div>
