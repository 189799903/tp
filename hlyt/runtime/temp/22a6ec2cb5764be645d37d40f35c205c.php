<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\phpstudy\WWW\hanlinyuntong\hlyt\public/../application/index\view\syno\show.html";i:1526039094;s:76:"E:\phpstudy\WWW\hanlinyuntong\hlyt\application\index\view\common\header.html";i:1526365374;s:74:"E:\phpstudy\WWW\hanlinyuntong\hlyt\application\index\view\common\left.html";i:1526369122;}*/ ?>
<!DOCTYPE html>
...
<body>
  ...
  <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
    <thead>
      <tr role="row">
        <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="邮箱: activate to sort column ascending" aria-sort="ascending" style="width: 164px;">邮箱</th>
        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="电话: activate to sort column ascending" style="width: 254px;">电话</th>
        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="公司qq: activate to sort column ascending" style="width: 231px;">公司qq</th>
        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="公司客服QQ: activate to sort column ascending" style="width: 139px;">公司客服QQ</th>
        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="公司简介: activate to sort column ascending" style="width: 98px;">公司简介</th>
    ...
    <tbody>
      ...
      <tr class="gradeA odd">
        <td class="sorting_1"><?php echo $v['company_email']; ?></td>
        <td class=" "><?php echo $v['company_tel']; ?></td>
        <td class=" "><?php echo $v['company_qq']; ?></td>
        <td class="center "><?php echo $v['company_connect_qq']; ?></td>
        <td class="center "><?php echo $v['company_sum']; ?></td>
        <td class="center ">
        	<a href="update?id=<?php echo $v['company_id']; ?>">修改</a>
        </td></tr>
     <?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
  </table>
  <div class="row">
                	...
                	<div class="pagelist">
				        ...
				        <a href="<?=URL('index/syno/show')?>?page=1">首页</a>
				        <a href="<?=URL('index/syno/show')?>?page=<?php echo $date['up']; ?>">上一页</a>
				        <a href="<?=URL('index/syno/show')?>?page=<?php echo $date['next']; ?>">下一页</a>
				        <a href="<?=URL('index/syno/show')?>?page=<?php echo $date['page_num']; ?>">尾页</a>
				      </div>
