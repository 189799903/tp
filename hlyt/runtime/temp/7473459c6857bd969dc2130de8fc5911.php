<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\phpstudy\WWW\hanlinyuntong\hlyt\public/../application/index\view\broad\add.html";i:1526043198;s:76:"E:\phpstudy\WWW\hanlinyuntong\hlyt\application\index\view\common\header.html";i:1526365374;s:74:"E:\phpstudy\WWW\hanlinyuntong\hlyt\application\index\view\common\left.html";i:1526369122;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                	<form action="/hanlinyuntong/hlyt/public/index/broad/add" method="post"  enctype="multipart/form-data"> 
                		<div class="form-group">
	                        <label>上传图片</label>
	                        <input type="file" name="slowing_img[]"><br>
	                     	<label>图片介绍</label>
		                    <textarea class="form-control" name="slowing_sum[]" rows="3"></textarea>
...
<script src="/hanlinyuntong/hlyt/public/jquery-1.8.2.min.js"></script>
