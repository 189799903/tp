<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\cases\show.html";i:1526382746;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
  <!DOCTYPE html>
                        ...
                        <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeU">
                                    ...
                                    <td><img src="/uploads/<?php echo $v['case_logo']; ?>" alt="" width="50" height="50"></td>
                                    <td><?php echo $v['case_info']; ?></td>
                                    <td><?php echo $v['case_sum']; ?></td>
                                    <td><?php echo $v['case_type']; ?></td>
                                    <td><?php echo $v['case_path']; ?></td>
                                    <td><button onclick="del(<?php echo $v['case_id']; ?>,<?php echo $p['page']; ?>)" >删除</button><a href="<?php echo url('cases/update'); ?>?id=<?php echo $v['case_id']; ?>">修改</a></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                                </table>
...
<script>
    ...
    xhr.open('get',"<?php echo url('cases/dele'); ?>?id="+id+"&page="+page);
    xhr.send();
...
str+='<td><img src="/uploads/'+content[i]['case_logo']+'" alt="" width="50" height="50"></td>';
str+="<td>"+content[i]['case_info']+"</td>";
str+="<td>"+content[i]['case_sum']+"</td>";
str+="<td>"+content[i]['case_type']+"</td>";
str+="<td>"+content[i]['case_path']+"</td>";
str+="<td><button onclick='del("+content[i]['case_id']+","+content[i]['page']+")' >删除</button><a href='/index/cases/update?id="+content[i]['case_id']+"'>修改</a></td></tr>";
document.getElementsByTagName('tbody')[0].innerHTML=str;
    ...
    function page(page){
    var xhr=new XMLHttpRequest();
    xhr.open('get',"<?php echo url('cases/show'); ?>?page="+page);
    xhr.send();
    xhr.onreadystatechange=function(){
      if (xhr.readyState==4&&xhr.status==200) {
