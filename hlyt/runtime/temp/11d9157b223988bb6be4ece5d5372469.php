<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\cases\add.html";i:1526379496;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526369122;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="col-lg-6">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>案例标题</label>
                                        <input class="form-control" type="text" name="case_title">
                                    </div>
                                      <div class="form-group">
                                            <label>案例图片</label>
                                            <input type="file" name="case_logo">
                                        </div>
                                       <div class="form-group">
                                        <label>案例信息</label>
                                        <input class="form-control" type="text" name="case_info">
                                    </div>
                                     <div class="form-group">
                                        <label>案例详情</label>
                                        <textarea  style="width:800px;height: 500px;" name="case_sum" id="container"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>案例类型</label>
                                     ...
                                     <div class="form-group">
                                        <label>案例路径</label>
                                        <input class="form-control" type="text" name="case_path">
                                    </div>
