<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\user\update.html";i:1526643096;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526699712;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
<!DOCTYPE html>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                   ...
                   <ul class="dropdown-menu dropdown-user">
                        <li><a href="/index/user/index"><i class="fa fa-user fa-fw"></i> 用户中心</a>
                        </li>
                        <li><a href="/index/user/update"><i class="fa fa-gear fa-fw"></i> 密码修改</a>
                        </li>
                        <li class="divider"></li>
                    ...
                    <div id="page-inner">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="/index/user/update" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>新密码：</label>
                                                <input  class="form-control" type="input" name="new" >
                                            </div>
                                            <div class="form-group">
                                                <label>确认密码：</label>
                                                <input  class="form-control" type="input" name="newp">
                                            </div>
