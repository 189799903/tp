<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\skill\add.html";i:1526374204;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526369122;}*/ ?>
<!DOCTYPE html>
              	...
              	<div class="row">
                	<div class="col-lg-12">
                    	<div class="panel panel-default">
                        	<div class="panel-heading">技术设计添加</div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>技术设计LOGO</label>
                                        <input type="file" name="skill_logo">
                                    </div>
                                    <div class="form-group">
                                        <label>技术设计简介</label>
                                        <textarea id="container" name="skill_sum"  style="width:800px;height: 500px;" ></textarea>
                                    </div>
