<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\news\add.html";i:1526374024;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
<!DOCTYPE html>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <select class="form-control" name="n_type">
                                                 <?php if(is_array($n_type) || $n_type instanceof \think\Collection || $n_type instanceof \think\Paginator): $i = 0; $__LIST__ = $n_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $v['t_id']; ?>"><?php echo $v['t_type']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                     <div class="form-group">
                                        <label>新闻内容</label>
                                        <textarea  style="width:800px;height: 500px;" name="n_content" id="container"></textarea>
                                    </div>
