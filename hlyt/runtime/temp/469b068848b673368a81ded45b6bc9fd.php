<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\phpstudy\WWW\hlyt\hlyt\public/../application/index\view\recruit\add.html";i:1526374094;s:67:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\header.html";i:1526365374;s:65:"E:\phpstudy\WWW\hlyt\hlyt\application\index\view\common\left.html";i:1526625187;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript"  src="/Udictor/utf8-php/ueditor.config.js"></script>

<!-- 编辑器源码文件 -->

<script type="text/javascript" src="/Udictor/utf8-php/ueditor.all.js"></script>

<!-- 语言包文件(建议手动加载语言包，避免在ie下，因为加载语言失败导致编辑器加载失败) -->
<script type="text/javascript" src="/Udictor/utf8-php/lang/zh-cn/zh-cn.js"></script>
    <meta charset="utf-8" />
                            ...
                            <div class="col-lg-6">
                                <form action="" method="post">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>职位类别</label>
                                        <input class="form-control" type="text" name="r_type">
                                    </div>
                                     <div class="form-group">
                                        <label>招聘人数</label>
                                        <input class="form-control" type="text" name="r_num">
                                    </div>
                                     <div class="form-group">
                                        <label>工作地点</label>
                                        <input class="form-control" type="text" name="r_region">
                                    </div>
                                     <div class="form-group">
                                        <label>招聘时限</label>
                                        <input class="form-control" type="text" name="r_expiryTime">
                                    </div>
                                     <div class="form-group">
                                        <label>任职要求</label>
                                        <textarea id="container" rows="3" name="r_demand" style="width:800px;height: 500px;"></textarea>
                                    </div>
                                     <div class="form-group">
                                        <label>悬赏金额</label>
                                        <input class="form-control" type    ="text" name="r_money">
                                    </div>
                                     <div class="form-group">
                                            <label>招聘分区</label>
                                            <select class="form-control" name="r_place">
                                                <option value="1">郑州
                                                <option value="2">郑东新区
                                            </select>
                                        </div>
